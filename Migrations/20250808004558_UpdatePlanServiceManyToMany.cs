...
{
    /// <inheritdoc />
    public partial class UpdatePlanServiceManyToMany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanServices", x => new { x.SubscriptionPlanId, x.ServiceId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanServices_SubscriptionPlans_SubscriptionPlanId",
